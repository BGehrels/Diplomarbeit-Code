...
public class GraphGenerationBatch {
	...
	private static void generateAGeoffFile(int numberOfNodes, int numberOfEdges, String fileName) throws IOException {
		...
		//Generator generator = new SimpleGenerator(edgeFactory, new MyNodeFactory(writer), numberOfNodes, numberOfEdges);
	...
	public static byte getLabel() {
		int rndValue = SimpleGenerator.RANDOM.nextInt(1000000000);
		double sum = 0;
		for (byte i = 1; i <= 4; i++) {
